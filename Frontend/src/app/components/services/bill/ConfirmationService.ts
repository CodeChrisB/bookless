...
export class confirmationService {
  ...
  static getconfirmations():IOfferData[]{
    return confirmation;
  }

  static addconfirmation(newconfirmation:IOfferData){
  ...
  static getconfirmation(number:number): IOfferData{
    return confirmation.filter(o=>o.offer.number == number)[0]
  }

  static updateconfirmation(updatedconfirmation:IOfferData){
