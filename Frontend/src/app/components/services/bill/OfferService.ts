...
[
  {offer:{number:1,date:date1,customerId:1,isCompany:true,name:'Thermenbad',plz:"4050",town:'Leonding',street:'Ritzlhofstraße',bruttoValue:2750,status:'laufend',administrator:{firstname:'Michaela',lastname:'Buchberger'},stages:{offer:true,order:false,bill:true,finished:true,canceld:true}},
  prodcuts:[
