...
export class ConfirmationPdfService{
  ...
  */
  ...
  initData(id: number, isCompany: boolean){
    ...
    let user = UserService.getUser(this.offer.consultantId);
    ...
    if (isCompany){
      let customer = CompanyService.getCustomer(id);
      // leftblock
      ...
      let privateCustomer = CustomerService.getCustomer(id);
      // leftblock
    ...
    dd = {
      content: [
        ...
        // order data
       {
                  ...
                  fontSize: '10',
                      table: {
                              body: [
                                      [
                                        {
                                          text: 'Bestätigungsinformationen',
        ...
        // customer salutation
        {
            text: 'Bestätigung an ' + this.pdfData.upperTextBlock.orderName,
            style: 'bold'
        },
        {
        ...
        {
            text: 'Herzlichen Dank für Ihr Intersse. Wie besprochen, erlauben wir uns Ihnen verbindlich folgende Positionen anzubieten:',
            style: 'smallTopGap'
        },
         {
                style: 'productTable',
