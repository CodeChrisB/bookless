...
export class OfferPdfService{
  ...
  constructor(offer,stages,products:IRawProduct[]){
    this.offer = offer;
    this.stages=stages;
...
const dd = {
	content: [
		...
		{
		    style:'right',
		    text: 'Datum: 25.12.2020'
		},
		{
		    style:'right',
		    text: 'Angebot: An-1/2020'
		},
		{
		    style:'right',
		    text: 'Sachbearbeiter: Michaela Buchberger'
		},
		//customer salutation
		{
